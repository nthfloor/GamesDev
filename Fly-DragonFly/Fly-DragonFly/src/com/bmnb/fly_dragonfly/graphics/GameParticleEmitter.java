...
//		if (lastDotIndex != -1) imageName = imageName.substring(0, lastDotIndex);
	...
	public GameParticleEmitter (GameParticleEmitter emitter) {
...
//		com.badlogic.gdx.graphics.g2d.ParticleEmitter
		...
		if (additive) spriteBatch.setBlendFunction(GL20.GL_SRC_ALPHA, GL20.GL_ONE);
...
//		game.addParticle(p);
	...
	private void activateParticle (int index) {
		...
		com.bmnb.fly_dragonfly.screens.GameScreen.addObject(particle);
	}
	...
	public static class Particle extends GameObject {
