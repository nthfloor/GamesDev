 ...
 *
 */
public class PhysicalObject extends GridGameObject {
    ...
    private int numberOfDirectionTextures = 72;
//    private float direction;    
     ...
     */
    public PhysicalObject(float x, float y, int health,float m,int iCooldown){
     ...
     */
    public void applyForceInDirection(float dir, float force) {
        applyForce((float)Math.sin(Math.toRadians(dir))*force, (float)-Math.cos(Math.toRadians(dir))*force);
        setDirection(dir);
    }
    ...
    //to control direction of bullet
...
//        direction = dir;
        ...
        float offsetDirection = dir+(360.0f/numberOfDirectionTextures)/2.0f;
